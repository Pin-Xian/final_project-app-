...
public class Article2SimilarActivity extends AppCompatActivity {
    ListView mLsvInfo;
    String[] title = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_article2_similar);
    ...
    public void goToKeyword1(View view) {
        Intent intent =  new Intent(Article2SimilarActivity.this, Article2KeyWord1Activity.class);
        startActivity(intent);
    }

    public void goToKeyword2(View view) {
        Intent intent =  new Intent(Article2SimilarActivity.this, Article2KeyWord2Activity.class);
        startActivity(intent);
    }

    public void goToKeyword3(View view) {
        Intent intent =  new Intent(Article2SimilarActivity.this, Article2KeyWord3Activity.class);
        startActivity(intent);
    }

    public void goToKeyword4(View view) {
        Intent intent =  new Intent(Article2SimilarActivity.this, Article2KeyWord4Activity.class);
        startActivity(intent);
    }
}
