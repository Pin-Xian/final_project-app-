...
public class Article1SimilarActivity extends AppCompatActivity {
    ListView mLsvInfo;
    String[] title = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_article1_similar);
    ...
    public void goToKeyword1(View view) {
        Intent intent =  new Intent(Article1SimilarActivity.this, Article1KeyWord1Activity.class);
        startActivity(intent);
    }

    public void goToKeyword2(View view) {
        Intent intent =  new Intent(Article1SimilarActivity.this, Article1KeyWord2Activity.class);
        startActivity(intent);
    }

    public void goToKeyword3(View view) {
        Intent intent =  new Intent(Article1SimilarActivity.this, Article1KeyWord3Activity.class);
        startActivity(intent);
    }

    public void goToKeyword4(View view) {
        Intent intent =  new Intent(Article1SimilarActivity.this, Article1KeyWord4Activity.class);
        startActivity(intent);
    }
}