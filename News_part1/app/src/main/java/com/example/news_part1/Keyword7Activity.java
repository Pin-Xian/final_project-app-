...
public class Keyword7Activity extends AppCompatActivity {
    ListView mLsvInfo;
    String[] title = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyword7);
        ...
        mLsvInfo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent =  new Intent(Keyword7Activity.this, Main3Activity.class);
